 ...
 *
 */
public class Comparator extends WallMountGate implements BlockHandler, IntConsumer {

	private IntConsumer out;
	private BlockReference blockRef;
	private int clock, value;
	...
	public void accept(int val) {
		...
		val = world.getBlockState(pos).getComparatorInputOverride(world, pos);
		if (val == value) return;
		value = val;
