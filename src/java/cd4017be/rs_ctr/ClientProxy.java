...
public class ClientProxy extends CommonProxy {
	...
	public void registerModels(ModelRegistryEvent ev) {
		...
		addGates(
			...
			SPLITTER_B, MULTIPLEX_B, DELAY_B, PROCESSOR, PROCESSOR2, PROCESSOR3, COMPARATOR, POWER_HUB, 
			ITEM_TRANSLOCATOR, FLUID_TRANSLOCATOR, ENERGY_VALVE, PANEL, SOLAR_CELL, BLOCK_SELECTOR, 
			BLOCK_BREAKER, BLOCK_BREAKER1, ITEM_PLACER, OC_ADAPTER, RAM, CHUNK_LOADER, TELEPORTER, TELEPORTER1,
			BLOCK_DESERIALIZER, BLOCK_REORIENTER, INT_PANEL
		);
		...
		registerRender(remote);
		registerRender(socket_s);
		registerRender(socket_b);
	}
