...
public class ClientProxy extends CommonProxy {
	...
	public void registerModels(ModelRegistryEvent ev) {
		...
		addGates(SPLITTER, ANALOG_COMB, LOGIC_COMB, NUM_COMB, BIN_COMB, BIN_SPLIT, XOR_GATE, PROCESSOR, PROCESSOR2, COMPARATOR, POWER_HUB, ITEM_TRANSLOCATOR, FLUID_TRANSLOCATOR, PANEL, SOLAR_CELL);
